    ...
    public partial class FirstDeploy : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Category = c.String(nullable: false, maxLength: 450, unicode: false),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        FeedURL = c.String(nullable: false, maxLength: 450, unicode: false),
                        Domain = c.String(),
                        Category = c.String(),
                        DateFeedInsertion = c.DateTime(nullable: false),
                        IdUser = c.String(),
                        FeedEnabled = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.FeedURL);
            
            CreateTable(
                "dbo.LinksModels",
                c => new
                    {
                        Url = c.String(nullable: false, maxLength: 450, unicode: false),
                        Title = c.String(),
                        Domain = c.String(),
                        Intro = c.String(),
                        Category = c.String(),
                        ...
                        UrlRating = c.Single(nullable: false),
                        DateCertified = c.DateTime(nullable: false),
                        IdUserCertified = c.String(),
                    })
                .PrimaryKey(t => t.Url);
