namespace T2.Migrations
{
    ...
    public partial class DeployOne : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        FeedURL = c.String(nullable: false, maxLength: 128),
                        Domain = c.String(),
                        Category = c.String(),
                ...
                c => new
                    {
                        ...
                        Intro = c.String(),
                        Category = c.String(),
                        IsTrueCertified = c.Boolean(),
                        IsFalseCertified = c.Boolean(),
                        UrlRating = c.Single(),
                        DateCertified = c.DateTime(),
